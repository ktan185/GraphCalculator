...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void TY_01_N_iterative_BFS() throws Exception {
    ...
    @Test
    public void TY_02_N_iterative_DFS() throws Exception {
    ...
    @Test
    public void TY_03_N_recursive_BFS() throws Exception {
    ...
    @Test
    public void TY_04_N_recursive_DFS() throws Exception {
    ...
    @Test
    public void TY_01_O_iterative_BFS() throws Exception {
    ...
    @Test
    public void TY_02_O_iterative_DFS() throws Exception {
    ...
    @Test
    public void TY_03_O_recursive_BFS() throws Exception {
    ...
    @Test
    public void TY_04_O_recursive_DFS() throws Exception {
    ...
    @Test
    public void TY_01_P_check_roots() throws Exception {
    ...
    // dfs and bfs of p.txt (or whatever you named the file I have given you)
    @Test
    public void TY_02_P_IBFS() throws Exception {
    ...
    @Test
    public void TY_03_P_RBFS() throws Exception {
    ...
    @Test
    public void TY_04_P_IDFS() throws Exception {
    ...
    @Test
    public void TY_05_P_RDFS() throws Exception {
